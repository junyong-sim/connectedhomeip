...
CHIP_ERROR ThreadStackManagerImpl::_InitThreadStack()
{
    ...
    sprintf(fileName, "%s/lib/libopenthread.so.%s", currentDir, IoTer::getSamsungThreadVersion());
    ...
    snprintf(threadSettingsFileName, sizeof(threadSettingsFileName), "0_%lx.data", nodeId);
